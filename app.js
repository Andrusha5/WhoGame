...
// ============================================================================
// 2. ПОЛНЫЙ РЕЕСТР ПАКОВ И ТЕКСТОВЫХ ИМЕН
// ============================================================================
const PACK_REGISTRY = {
  cars: [
  ...
  bloggers: [
    ...
    { name: "Литвин", file: "9.jfif" }, { name: "Асхаб Тамаев", file: "10.jfif" },
    ...
    { name: "Дима Масленников", file: "21.jfif" }, { name: "Хабиб", file: "22.jfif" },
  ...
  celebrities: [
    ...
    { name: "Павел Воля", file: "3.jpg" }, { name: "Ольга Бузова", file: "4.jpg" },
    ...
    { name: "Настя Ивлеева", file: "11.jpg" }, { name: "Ксения Собчак", file: "12.jpg" },
    { name: "Юрий Дудь", file: "13.jpg" }, { name: "Иван Ургант", file: "14.jpg" },
    { name: "Александр Петров", file: "15.jpg" }, { name: "Данила Козловский", file: "16.jpg" },
    { name: "Павел Прилучный", file: "17.jpg" }, { name: "Иван Охлобыстин", file: "18.jpg" },
    { name: "Федор Бондарчук", file: "19.jpg" }, { name: "Шаман", file: "20.jpg" },
    { name: "Баста", file: "21.jpg" }, { name: "Оксана Самойлова", file: "22.jpg" },
...
// ============================================================================
// 6. ИГРОВОЕ ПОЛЕ И НАДЕЖНАЯ ПОДГРУЗКА КАРТИНОК
// ============================================================================
